    ...
    data: {
      ...
      html: applicationShell({
        ...
        details: [
          ...
          { label: 'Candidate portal', value: `<a href="${env.portalBaseUrl}/applications" style="color:#0F9D7A;text-decoration:none;font-weight:700">View your applications</a>`, html: true },
        ],
  ...
  return postEmail({
    ...
    data: {
      ...
      html: applicationShell({
        ...
        intro: 'A new application has been submitted through the candidate portal and should now be visible in the staff recruitment workspace.',
        accent: '#2F6FED',
        details: [
        ...
        note: 'Review this application in the staff portal recruitment tab.',
      }),
    },
  })
}
